...
def cli() -> None:
    ...
    program.add_argument('--torch', help=wording.get('install_dependency_help').format(dependency='torch'), dest='torch', choices=TORCH.keys(), default='cuda')  # Set default value to 'cuda'
    program.add_argument('--onnxruntime', help=wording.get('install_dependency_help').format(dependency='onnxruntime'), dest='onnxruntime', choices=ONNXRUNTIMES.keys(), default='cuda')  # Set default value to 'cuda'
